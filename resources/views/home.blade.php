...
@section('content')
    ...
    <section class="main-slider">
        <ul class="bxslider">
            <li><div class="slider-item"><img src="{{asset('images/1140x500-2.jpg')}}" title="Funky roots" /><h2><a href="post.html" title="Vintage-Inspired Finds for Your Home">Vintage-Inspired Finds for Your Home</a></h2></div></li>
            <li><div class="slider-item"><img src="{{asset('images/1140x500-1.jpg')}}" title="Funky roots" /><h2><a href="post.html" title="Vintage-Inspired Finds for Your Home">Vintage-Inspired Finds for Your Home</a></h2></div></li>
            <li><div class="slider-item"><img src="{{asset('images/1140x500-3.jpg')}}" title="Funky roots" /><h2><a href="post.html" title="Vintage-Inspired Finds for Your Home">Vintage-Inspired Finds for Your Home</a></h2></div></li>
        </ul>
    </section>
    <section>
        <div class="row">
            <div class="col-md-8">
                <article class="blog-post">
                    <div class="blog-post-image">
                        <a href="post.html"><img src="{{asset('images/750x500-1.jpg')}}" alt=""></a>
                    </div>
                ...
                <article class="blog-post">
                    <div class="blog-post-image">
                        <a href="post.html"><img src="{{asset('images/750x500-2.jpg')}}" alt=""></a>
                    </div>
                    <div class="blog-post-body">
                ...
                <article class="blog-post">
                    <div class="blog-post-image">
                        <a href="post.html"><img src="{{asset('images/750x500-3.jpg')}}" alt=""></a>
                    </div>
                    <div class="blog-post-body">
                ...
                <aside>
                    ...
                    <div class="sidebar-widget">
                        ...
                        <div class="widget-container widget-about">
                            <a href="post.html"><img src="{{asset('images/author.jpg')}}" alt=""></a>
                            <h4>Jamie Mooz</h4>
                        ...
                        <div class="widget-container">
                            <article class="widget-post">
                                <div class="post-image">
                                    <a href="post.html"><img src="{{asset('images/90x60-1.jpg')}}" alt=""></a>
                                </div>
                                <div class="post-body">
                            ...
                            <article class="widget-post">
                                <div class="post-image">
                                    <a href="post.html"><img src="{{asset('images/90x60-2.jpg')}}" alt=""></a>
                                </div>
                                <div class="post-body">
                            ...
                            <article class="widget-post">
                                <div class="post-image">
                                    <a href="post.html"><img src="{{asset('images/90x60-3.jpg')}}" alt=""></a>
                                </div>
                                <div class="post-body">
                                    <h2><a href="post.html">The State of the Word 2014</a></h2>
                                    <div class="post-meta">
                            ...
                            <article class="widget-post">
                                <div class="post-image">
                                    <a href="post.html"><img src="{{asset('images/90x60-4.jpg')}}" alt=""></a>
                                </div>
                                <div class="post-body">
                                    <h2><a href="post.html">Vintage-Inspired Finds for Your Home</a></h2>
                                    <div class="post-meta">
                            ...
                            <article class="widget-post">
                                <div class="post-image">
                                    <a href="post.html"><img src="{{asset('images/90x60-5.jpg')}}" alt=""></a>
                                </div>
                                <div class="post-body">
                                    <h2><a href="post.html">The State of the Word 2014</a></h2>
                                    <div class="post-meta">
